        ...
        if ($platformCreated) {
            ...
            <div class="row">
                <div class="alert alert-success" role="alert">
                    Plataforma creada correctamente.<br><a href="index.php?controller=platform&action=list">Volver al listado de plataformas</a>
                </div>
            </div>
            <?php
        } else {
            ...
            <div class="row">
                <div class="alert alert-danger" role="alert">
                    La plataforma no se ha creado correctamente.<br><a href="index.php?controller=platform&action=create">Volver a intentarlo</a>
                </div>
            </div>
            <?php
        }
